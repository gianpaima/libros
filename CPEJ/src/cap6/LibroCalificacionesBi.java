...
public class LibroCalificacionesBi {

    private String nombreDelCurso;

    private int[][] calificaciones;

    public LibroCalificacionesBi(String nombreDelCurso, int[][] calificaciones) {
    ...
    public void procesarCalificaciones() {
        ...
        System.out.printf("%n%s %d%n%s %d%n%n",
                "Las calificacion mas baja en el libro de calificaciones es",
                obtenerMinima(),
                "La calificacion mas alta en el libro de caficaciones es",
                obtenerMaxima());
